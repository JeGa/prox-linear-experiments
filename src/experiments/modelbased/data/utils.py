...
def get_samples(dataloader, num_samples, device=None):
    """
    ...
    :param device: Pytorch device for the returned data. If None cpu is used.
    ...
    return x.to(device), yt.to(device)
